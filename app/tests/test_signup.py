...
def test_signup_success_login(client_no_ratelimit):
...
# Testa JSON inválido
def test_signup_not_valid_json(client_no_ratelimit):
...
def test_signup_empty_fields(client_no_ratelimit):
...
def test_signup_invalid_email_format(client_no_ratelimit):
...
def test_signup_email_already_taken(client_no_ratelimit):
...
def test_signup_invalid_password_confirm(client_no_ratelimit):
...
def test_signup_invalid_birth_date_format(client_no_ratelimit):
...
def test_signup_invalid_birth_date_age(client_no_ratelimit):
